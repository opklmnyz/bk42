...
UUID=${UUID:-'ed083b74-d686-4844-90f1-a918c50b9e52'}
VMESS_WSPATH=${VMESS_WSPATH:-'/96a28942-b2b0-4f95-9191-48b2c9612a0b-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/1b00c36e-8a4f-41cf-8429-405ad7cd228c-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/96a28942-b2b0-4f95-9191-48b2c9612a0b-trojan'}
SS_WSPATH=${SS_WSPATH:-'/990ff33a-46f3-4af9-8e92-f83197f2d38f-shadowsocks'}
